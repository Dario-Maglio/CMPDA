...
from Python_SciPy.Python_practice.Assignment_2.assignment_2 import VoltageData
...
class TestCore(unittest.TestCase):
    ...
    def tests(self):
        # Load some data
        t, v = numpy.loadtxt('Python_SciPy/Python_practice/Assignment_2/sample_data_file.txt', unpack=True)
