Program Drive_interp
 ...
 Implicit none
 integer(4), Parameter::N=50,M=1000
 Real(rk), Parameter::a=-5._rk,b=5._rk,a2=-6._rk,b2=6._rk
 Integer(4)::i
 ...
 End do
 y=(1._rk/x)                                                     !Chiamo funzione e ci carico un vettore dandogli vettore  
 ...
 Do i=0,M
    ...
    ta=ta+(t3-t2)
    tu=tu+(t4-t3)
    write(1,'(I4,5(x,E19.12))')i,x0,(1._rk/x0),y0l,y0a,y0u
    write(*,'(I4,5(x,E19.12))')i,x0,(1._rk/x0),y0l,y0a,y0u
 End do
